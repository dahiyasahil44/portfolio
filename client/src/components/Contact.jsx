...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "Sonipat, Haryana - 131001",
  },
  {
    icon: faEnvelope,
    title: "Mail to",
    description: "imsahil440407@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me",
    description: "+91-893-050-9185",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                Drop me a message if you think I'd be a good fit for your project.
              </p>
            </div>
